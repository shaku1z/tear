...
and the normal aggregate correctly reject. The serial State Forge browser task
also recovered from one 30-second `page.reload` timeout on its single bounded

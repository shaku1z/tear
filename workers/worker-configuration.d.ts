/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ghost.jsonc workers/worker-configuration.d.ts` (hash: 85ff5d838641650a9cec2943f402a1aa)
// Runtime types generated with workerd@1.20260714.1 2026-07-23 nodejs_compat
interface __BaseEnv_Env {
	GHOST_CAPSULES: R2Bucket;
	GHOST_METADATA: D1Database;
	GHOST_VERIFIER: Fetcher /* tear-ghost-verifier */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./ghost-publication");
	}

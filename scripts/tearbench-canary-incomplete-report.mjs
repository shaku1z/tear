...
const results = JSON.parse(values["--results"]), payload = { format: "tearbench-canary-parity-report", schemaVersion: 2,
  generatedAt: new Date().toISOString(), status: "incomplete", planDigest: null, shardPlanDigest: null,
  source: null, providerOrigin: null, plantedFailureTaskId: null, taskParity: null, claimParity: null, metrics: null,

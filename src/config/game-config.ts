...
// ============================================================
const PAD_DEFAULTS: GamepadSettings = {
  dead: 0.22, menuRepeat: 0.24, triggerThreshold: 0.35, menuScrollDead: 0.25,
  menuScrollMaxSpeed: 950, activityBias: 0.12, deadL: 0.22, deadR: 0.22,
  aimSens: 1, tetherMode: "hold", doubleTapDash: false, doubleTapWindow: 0.25,
  vibration: "medium", glyphStyle: "auto",
};

const CONFIG = {
  view: { w: 1600, h: 900 },
  pad: PAD_DEFAULTS,
  effects: { highBudget: 320, lowBudget: 110, cullMargin: 180, voidArrivalFxStep: 0.07 },
  touch: { aimBoost: 1.5, stickRadius: 130, stickDead: 10, joyFollow: 96 },
  ...
  warden: {
    ...
    lungeRange: 620, lungeWind: 0.42, lungeSpeed: 1500, lungeDmg: 18,   // shared speed preserves the former last-key-wins value for baton lunges and ceiling dives
    zoneCount: 3, zoneW: 200, zoneShift: 7, zoneTick: 7, zoneTickCd: 0.4,   // phase-2 prohibited zones
    ceilingY: 150, ceilDropCd: 1.6, lungeCd: 7.5, lungeWindup: 0.55,   // phase-3 ceiling: lock + telegraph, then dive

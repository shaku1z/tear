...
export interface TearHumanCalibrationConsentAttestationV1 {
  ...
  readonly consent: "anonymous-improvement" | "public-training"; readonly consentRevisionHash: string; readonly device: "keyboard-mouse" | "controller" | "touch";
...
export class TearHumanCalibrationSourceStore {
  readonly #backend: GhostVaultBackend; readonly #vault: GhostLocalVault; readonly #ledger: TearHumanCalibrationConsentLedger | undefined;
  constructor(backend: GhostVaultBackend, vault: GhostLocalVault, ledger?: TearHumanCalibrationConsentLedger) { this.#backend = backend; this.#vault = vault; this.#ledger = ledger; }

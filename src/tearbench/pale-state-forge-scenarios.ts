...
const PALE_SURGICAL_BASE: TearSdlDocumentV1 = Object.freeze({
  ...
  start: Object.freeze({ mode: "campaign", difficulty: "normal", weapon: "sword", stage: "pale-traverse", wave: 41 }),
  tags: Object.freeze(["pale-traverse", "state-forge", "engineering-only", "non-publishable", "pt3-c10"]),
});

/** Surgical stage-owned Aurora lane at the first legal Pale campaign wave. */

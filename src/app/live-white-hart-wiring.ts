import type { EnvironmentRuntime, WhiteHartEnvironmentActor } from "../gameplay/environment/environment-runtime";
...
export function bindLiveWhiteHartActors(
  ...
  environment.setWhiteHartActorsSource(() => enemies().filter((enemy) => enemy.kind === "white-hart")

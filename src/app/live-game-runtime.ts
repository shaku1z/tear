...
(function () {
  ...
  const academyScreen = createLiveAcademyScreen(browserIndexedDb, currentSignedInActor), foundryScreen = createLiveFoundryScreen(browserIndexedDb), ghostLabHome = createLiveGhostLabHome();

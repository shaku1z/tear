...
import { LivePlayerWatchController } from "./live-player-watch-controller"; import { LiveGhostPublicationController } from "./live-ghost-publication-controller";
...
(function () {
  ...
  const academyScreen = createLiveAcademyScreen(browserIndexedDb, currentSignedInActor), foundryScreen = createLiveFoundryScreen(browserIndexedDb), ghostPublicationScreen = new LiveGhostPublicationController(browserIndexedDb, ghostPublication, currentSignedInActor);

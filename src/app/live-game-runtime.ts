...
(function () {
  ...
  const academyScreen = createLiveAcademyScreen(browserIndexedDb, currentSignedInActor), foundryScreen = createLiveFoundryScreen(browserIndexedDb), ghostPublicationScreen = new LiveGhostPublicationController(browserIndexedDb, ghostPublication, currentSignedInActor), ghostSupportScreen = new LiveGhostSupportController(browserIndexedDb);

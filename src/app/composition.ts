...
export function composeTearApplication(options: TearCompositionOptions): void {
  ...
  const gameRuntimeDependencies = {
    ...
    browserDocument: document, browserNavigator: navigator, browserWindow: window, CG, CLOCK, CONFIG: worldConfig, Charger, Chimera, Cinematics, Clipper: clipper, Cloud, Colossus, DAILY, DIAG, Echo,

  ...
  snapshot(): GhostLabScreenView {
    return Object.freeze({
      ...
      routes: Object.freeze([
        ...
        Object.freeze({ id: "botevidence", label: "BOT EVIDENCE", detail: "Read one exact retained canonical evaluation report when available." }),
      ...
      unavailable: Object.freeze([
        ...
        Object.freeze({ label: "BOT LADDER", detail: "No certified player ladder or placement is available; local evidence stays unassigned." }),

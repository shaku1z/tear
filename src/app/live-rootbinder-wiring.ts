import type { EnvironmentRuntime, RootbinderEnvironmentActor } from "../gameplay/environment/environment-runtime";
...
export function bindLiveRootbinderActors(
  ...
  environment.setRootbinderActorsSource(() => {
    ...
    return values.filter((enemy) => enemy.kind === "rootbinder").map((enemy): RootbinderEnvironmentActor => {

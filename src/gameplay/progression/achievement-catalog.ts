...
import { PUBLISHED_STAGE_IDS } from "../stages";
...
export const ACHIEVEMENT_CATALOG: readonly AchievementCatalogEntry[] = Object.freeze([
  ...
  stat("all_biomes", "progress", "rare", "Wayfarer", `Fight in all ${String(PUBLISHED_STAGE_IDS.length)} biomes.`, "biomesSeen", PUBLISHED_STAGE_IDS.length),

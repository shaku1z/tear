import type { WaveClearIntent } from "./wave-clear-planner";
import type { WavePlanIntent } from "./wave-planner";

/** Typed inward ports for applying wave-plan effects at a host boundary. */
...
/** Applies only declared wave-plan intents; planners retain no host authority. */
...
/** Typed inward ports for applying wave-clear effects at a host boundary. */
...
/** Applies only declared wave-clear intents; game rules do not reach host APIs. */

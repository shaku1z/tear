import type {
  AuroraTrackMomentumPolicy, AuroraTrackTransportEligibility, AuroraTrackVariant,
...
function assertDirection(direction: number): asserts direction is EnvironmentTrackDirection {
...
export function assertAuroraTrackFieldState(value: EnvironmentFieldState): asserts value is AuroraTrackFieldState {
  ...
  assertDirection(value.direction as number);

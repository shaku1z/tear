import type { EnvironmentClearReason, EnvironmentFieldState, EnvironmentForcePolicy, EnvironmentGeometry, EnvironmentObjectValidationPort, EnvironmentRuntimeState } from "./environment-contracts";
...
/** Verdant-only validation installed beside Verdant behavior at composition. */
export const BLOOM_WELL_VALIDATION: EnvironmentObjectValidationPort = Object.freeze({
  id: "verdant-bloom-well",
  validateField(field: EnvironmentFieldState) {

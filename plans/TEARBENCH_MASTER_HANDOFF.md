...
world state, and source architecture rejects restoring their closures. The
focused gate passed 5 files / 14 tests plus architecture, and rebuilt
campaign-victory browser proof passes. This does not establish durable storage,
a portable full production world, or C27A completion.
...
DONE THIS STEP:      Slice 80 routes transient combat collections directly through world state.
PROVEN BY:           Focused 5 files / 14 tests and architecture passed; rebuilt campaign-victory browser proof and the full canonical C27A aggregate passed. C27A remains blocking.
...
NEXT SLICE:          Select the next bounded actor or frame closure owned by the production host. Do not claim durability/device parity or full live-world concurrency.

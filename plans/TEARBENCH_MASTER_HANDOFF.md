...
NEXT SLICE:          Extend the active-curation split ledger into immutable versioned pre-corpus manifests with complete player/session/seed lineage and revocation-safe rebuilds; preserve hidden release-exam isolation and do not create a reviewed corpus sample yet.

...
NEXT SLICE:          C33: compose the persisted program runtime behind an explicit product command without ambient execution; do not turn it into automatic review, activation, or promotion.

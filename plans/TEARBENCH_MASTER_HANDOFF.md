...
NEXT SLICE:          Implement the inspectable Academy interface over durable C31 stores—lesson status, recordings, review/corrections, consent, split manifests, and storage—without treating the legacy in-memory corpus as the product surface.

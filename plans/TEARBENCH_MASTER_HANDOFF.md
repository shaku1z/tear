...
NEXT SLICE:          Prove a revocation-safe rebuilt trainer manifest after a reviewed sample's custody is revoked, then implement the inspectable Academy interface without treating the legacy in-memory corpus as the product surface.

...
DONE THIS STEP:      C33 now preserves governed training-scenario provenance and has a fail-closed source-world temporal-versus-scripted comparator whose completed, defeated, and revival facts come from native shared-world events. The tiny fixture has zero delta, so this is measurement plumbing, not a quality or promotion result.

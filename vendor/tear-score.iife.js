...
var TearScore = (() => {
  ...
  // ../core/src/runtime.ts
  var AbstractTearScoreRuntime = class {
    ...
    pause(reason) {
      if (this._state === "running") {
        ...
        if (reason) {
          this._logger?.info(`[TearScore] Paused due to: ${reason}`);
        }
      }
    }
    async resume(reason) {
    ...
    async dispose() {
      if (this._state !== "uninitialized" && this._state !== "disposed") {
        this.stop();
        await this.onDispose();
        this.setState("disposed");
        this._muteReasons.clear();
      }
    }
    setMuteReason(reason, isMuted) {
      const wasMuted = this.isMuted;
      if (isMuted) {
        this._muteReasons.add(reason);
      } else {
        this._muteReasons.delete(reason);
      }
      const currentlyMuted = this.isMuted;
      if (wasMuted !== currentlyMuted) {
        this.onMuteStateChanged(currentlyMuted);
      }
    }
  };
  ...
  var PRNG = class {
    ...
    constructor(seed) {
      if (typeof seed === "string") {
        this._state = this.hashString(seed);
      } else {
        this._state = seed;
      }
    }
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/version.js
  var version = "14.9.17";

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-extended-exponential-ramp-to-value-automation-event.js
  var createExtendedExponentialRampToValueAutomationEvent = (value, endTime, insertTime) => {
    return { endTime, insertTime, type: "exponentialRampToValue", value };
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-extended-linear-ramp-to-value-automation-event.js
  var createExtendedLinearRampToValueAutomationEvent = (value, endTime, insertTime) => {
    return { endTime, insertTime, type: "linearRampToValue", value };
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-set-value-automation-event.js
  var createSetValueAutomationEvent = (value, startTime) => {
    return { startTime, type: "setValue", value };
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-set-value-curve-automation-event.js
  var createSetValueCurveAutomationEvent = (values, startTime, duration) => {
    return { duration, startTime, type: "setValueCurve", values };
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/get-target-value-at-time.js
  var getTargetValueAtTime = (time, valueAtStartTime, { startTime, target, timeConstant }) => {
    return target + (valueAtStartTime - target) * Math.exp((startTime - time) / timeConstant);
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/guards/exponential-ramp-to-value-automation-event.js
  var isExponentialRampToValueAutomationEvent = (automationEvent) => {
    return automationEvent.type === "exponentialRampToValue";
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/guards/linear-ramp-to-value-automation-event.js
  var isLinearRampToValueAutomationEvent = (automationEvent) => {
    return automationEvent.type === "linearRampToValue";
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/guards/any-ramp-to-value-automation-event.js
  var isAnyRampToValueAutomationEvent = (automationEvent) => {
    return isExponentialRampToValueAutomationEvent(automationEvent) || isLinearRampToValueAutomationEvent(automationEvent);
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/guards/set-value-automation-event.js
  var isSetValueAutomationEvent = (automationEvent) => {
    return automationEvent.type === "setValue";
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/guards/set-value-curve-automation-event.js
  var isSetValueCurveAutomationEvent = (automationEvent) => {
    return automationEvent.type === "setValueCurve";
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/get-value-of-automation-event-at-index-at-time.js
  var getValueOfAutomationEventAtIndexAtTime = (automationEvents, index4, time, defaultValue) => {
    const automationEvent = automationEvents[index4];
    return automationEvent === void 0 ? defaultValue : isAnyRampToValueAutomationEvent(automationEvent) || isSetValueAutomationEvent(automationEvent) ? automationEvent.value : isSetValueCurveAutomationEvent(automationEvent) ? automationEvent.values[automationEvent.values.length - 1] : getTargetValueAtTime(time, getValueOfAutomationEventAtIndexAtTime(automationEvents, index4 - 1, automationEvent.startTime, defaultValue), automationEvent);
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/get-end-time-and-value-of-previous-automation-event.js
  var getEndTimeAndValueOfPreviousAutomationEvent = (automationEvents, index4, currentAutomationEvent, nextAutomationEvent, defaultValue) => {
    return currentAutomationEvent === void 0 ? [nextAutomationEvent.insertTime, defaultValue] : isAnyRampToValueAutomationEvent(currentAutomationEvent) ? [currentAutomationEvent.endTime, currentAutomationEvent.value] : isSetValueAutomationEvent(currentAutomationEvent) ? [currentAutomationEvent.startTime, currentAutomationEvent.value] : isSetValueCurveAutomationEvent(currentAutomationEvent) ? [
      ...
      getValueOfAutomationEventAtIndexAtTime(automationEvents, index4 - 1, currentAutomationEvent.startTime, defaultValue)
    ];
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/guards/cancel-and-hold-automation-event.js
  var isCancelAndHoldAutomationEvent = (automationEvent) => {
    return automationEvent.type === "cancelAndHold";
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/guards/cancel-scheduled-values-automation-event.js
  var isCancelScheduledValuesAutomationEvent = (automationEvent) => {
    return automationEvent.type === "cancelScheduledValues";
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/get-event-time.js
  ...
  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/get-exponential-ramp-value-at-time.js
  ...
  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/get-linear-ramp-value-at-time.js
  var getLinearRampValueAtTime = (time, startTime, valueAtStartTime, { endTime, value }) => {
    return valueAtStartTime + (time - startTime) / (endTime - startTime) * (value - valueAtStartTime);
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/interpolate-value.js
  ...
  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/get-value-curve-value-at-time.js
  var getValueCurveValueAtTime = (time, { duration, startTime, values }) => {
    const theoreticIndex = (time - startTime) / duration * (values.length - 1);
    return interpolateValue(values, theoreticIndex);
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/truncate-value-curve.js
  ...
  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/guards/set-target-automation-event.js
  var isSetTargetAutomationEvent = (automationEvent) => {
    return automationEvent.type === "setTarget";
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/classes/automation-event-list.js
  var AutomationEventList = class {
    ...
    add(automationEvent) {
      ...
      if (isCancelAndHoldAutomationEvent(automationEvent) || isCancelScheduledValuesAutomationEvent(automationEvent)) {
        const index4 = this._automationEvents.findIndex((currentAutomationEvent) => {
          if (isCancelScheduledValuesAutomationEvent(automationEvent) && isSetValueCurveAutomationEvent(currentAutomationEvent)) {
            return currentAutomationEvent.startTime + currentAutomationEvent.duration >= eventTime;
          }
          return getEventTime(currentAutomationEvent) >= eventTime;
        });
        const removedAutomationEvent = this._automationEvents[index4];
        if (index4 !== -1) {
        ...
        const index4 = this._automationEvents.findIndex((currentAutomationEvent) => getEventTime(currentAutomationEvent) > eventTime);
        const previousAutomationEvent = index4 === -1 ? this._automationEvents[this._automationEvents.length - 1] : this._automationEvents[index4 - 1];
        ...
        if (index4 === -1) {
          ...
          if (isSetValueCurveAutomationEvent(automationEvent) && eventTime + automationEvent.duration > getEventTime(this._automationEvents[index4])) {
            return false;
          }
          this._automationEvents.splice(index4, 0, persistentAutomationEvent);
        }
      }
      return true;
    }
    flush(time) {
      const index4 = this._automationEvents.findIndex((currentAutomationEvent) => getEventTime(currentAutomationEvent) > time);
      if (index4 > 1) {
        const remainingAutomationEvents = this._automationEvents.slice(index4 - 1);
        const firstRemainingAutomationEvent = remainingAutomationEvents[0];
        if (isSetTargetAutomationEvent(firstRemainingAutomationEvent)) {
          remainingAutomationEvents.unshift(createSetValueAutomationEvent(getValueOfAutomationEventAtIndexAtTime(this._automationEvents, index4 - 2, firstRemainingAutomationEvent.startTime, this._defaultValue), firstRemainingAutomationEvent.startTime));
        }
  ...
  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-cancel-and-hold-automation-event.js
  var createCancelAndHoldAutomationEvent = (cancelTime) => {
    return { cancelTime, type: "cancelAndHold" };
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-cancel-scheduled-values-automation-event.js
  var createCancelScheduledValuesAutomationEvent = (cancelTime) => {
    return { cancelTime, type: "cancelScheduledValues" };
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-exponential-ramp-to-value-automation-event.js
  var createExponentialRampToValueAutomationEvent = (value, endTime) => {
    return { endTime, type: "exponentialRampToValue", value };
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-linear-ramp-to-value-automation-event.js
  var createLinearRampToValueAutomationEvent = (value, endTime) => {
    return { endTime, type: "linearRampToValue", value };
  };

  // ../../node_modules/.pnpm/automation-events@7.1.19/node_modules/automation-events/build/es2019/functions/create-set-target-automation-event.js
  var createSetTargetAutomationEvent = (target, startTime, timeConstant) => {
    return { startTime, target, timeConstant, type: "setTarget" };
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/abort-error.js
  var createAbortError = () => new DOMException("", "AbortError");

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/add-active-input-connection-to-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/add-audio-node-connections.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/add-audio-param-connections.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/globals.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/is-constructible.js
  var handler = {
    construct() {
      return handler;
    }
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/split-import-statements.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/add-audio-worklet-module.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/get-value-for-key.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/pick-element-from-set.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/delete-passive-input-connection-to-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/get-event-listeners-of-audio-node.js
  var getEventListenersOfAudioNode = (audioNode) => {
    return getValueForKey(EVENT_LISTENERS, audioNode);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/set-internal-state-to-active.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/audio-worklet-node.js
  var isAudioWorkletNode = (audioNode) => {
    return "port" in audioNode;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/set-internal-state-to-passive.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/set-internal-state-to-passive-when-necessary.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/add-connection-to-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/add-passive-input-connection-to-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/add-silent-connection.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/add-unrendered-audio-worklet-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/analyser-node-constructor.js
  var DEFAULT_OPTIONS = {
    channelCount: 2,
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/is-owned-by-context.js
  var isOwnedByContext = (nativeAudioNode, nativeContext) => {
    return nativeAudioNode.context === nativeContext;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/analyser-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-buffer-copy-channel-methods-out-of-bounds-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/index-size-error.js
  var createIndexSizeError = () => new DOMException("", "IndexSizeError");

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/wrap-audio-buffer-get-channel-data-method.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-buffer-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/constants.js
  var MOST_NEGATIVE_SINGLE_FLOAT = -34028234663852886e22;
  var MOST_POSITIVE_SINGLE_FLOAT = -MOST_NEGATIVE_SINGLE_FLOAT;

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/is-active-audio-node.js
  var isActiveAudioNode = (audioNode) => ACTIVE_AUDIO_NODE_STORE.has(audioNode);

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-buffer-source-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-buffer-source-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/audio-buffer-source-node.js
  var isAudioBufferSourceNode = (audioNode) => {
    return "playbackRate" in audioNode;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/biquad-filter-node.js
  var isBiquadFilterNode = (audioNode) => {
    return "frequency" in audioNode && "gain" in audioNode;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/constant-source-node.js
  var isConstantSourceNode = (audioNode) => {
    return "offset" in audioNode;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/gain-node.js
  var isGainNode = (audioNode) => {
    return !("frequency" in audioNode) && "gain" in audioNode;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/oscillator-node.js
  var isOscillatorNode = (audioNode) => {
    return "detune" in audioNode && "frequency" in audioNode && !("gain" in audioNode);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/stereo-panner-node.js
  var isStereoPannerNode = (audioNode) => {
    return "pan" in audioNode;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/get-audio-node-connections.js
  var getAudioNodeConnections = (audioNode) => {
    return getValueForKey(AUDIO_NODE_CONNECTIONS_STORE, audioNode);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/get-audio-param-connections.js
  var getAudioParamConnections = (audioParam) => {
    return getValueForKey(AUDIO_PARAM_CONNECTIONS_STORE, audioParam);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/deactivate-active-audio-node-input-connections.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/deactivate-audio-graph.js
  var deactivateAudioGraph = (context2) => {
    deactivateActiveAudioNodeInputConnections(context2.destination, []);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/is-valid-latency-hint.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-context-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-destination-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-destination-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-listener-factory.js
    ...
    return (context2, nativeContext) => {
      ...
      const createFakeAudioParams = () => {
        ...
        const createFakeAudioParam = (input, initialValue, setValue) => {
          ...
          overwriteAccessors2(audioParam, "value", (get9) => () => get9.call(audioParam), (set) => (value) => {
            try {
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/audio-node.js
  var isAudioNode = (audioNodeOrAudioParam) => {
    return "context" in audioNodeOrAudioParam;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/audio-node-output-connection.js
  var isAudioNodeOutputConnection = (outputConnection) => {
    return isAudioNode(outputConnection[0]);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/insert-element-in-set.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/add-active-input-connection-to-audio-param.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/add-passive-input-connection-to-audio-param.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/native-audio-node-faker.js
  var isNativeAudioNodeFaker = (nativeAudioNodeOrNativeAudioNodeFaker) => {
    return "inputs" in nativeAudioNodeOrNativeAudioNodeFaker;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/connect-native-audio-node-to-native-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/delete-active-input-connection.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/delete-active-input-connection-to-audio-param.js
  var deleteActiveInputConnectionToAudioParam = (activeInputs, source, output) => {
    return pickElementFromSet(activeInputs, (activeInputConnection) => activeInputConnection[0] === source && activeInputConnection[1] === output);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/delete-event-listeners-of-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/delete-passive-input-connection-to-audio-param.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/disconnect-native-audio-node-from-native-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/get-native-audio-node.js
  var getNativeAudioNode = (audioNode) => {
    return getValueForKey(AUDIO_NODE_STORE, audioNode);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/get-native-audio-param.js
  var getNativeAudioParam = (audioParam) => {
    return getValueForKey(AUDIO_PARAM_STORE, audioParam);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/is-part-of-a-cycle.js
  var isPartOfACycle = (audioNode) => {
    return CYCLE_COUNTERS.has(audioNode);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/is-passive-audio-node.js
  var isPassiveAudioNode = (audioNode) => {
    return !ACTIVE_AUDIO_NODE_STORE.has(audioNode);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-node-disconnect-method-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/visit-each-audio-node-once.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/native-audio-node.js
  var isNativeAudioNode = (nativeAudioNodeOrAudioParam) => {
    return "context" in nativeAudioNodeOrAudioParam;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/wrap-audio-node-disconnect-method.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-param-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-param-renderer.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/read-only-map.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-worklet-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/copy-from-channel.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/copy-to-channel.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/create-nested-arrays.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/get-audio-worklet-processor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/audio-worklet-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/base-audio-context-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/biquad-filter-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/biquad-filter-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/cache-test-result.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/channel-merger-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/channel-merger-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/channel-splitter-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/channel-splitter-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/connect-audio-param.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/connect-multiple-outputs.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/connected-native-audio-buffer-source-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/constant-source-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/constant-source-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/convert-number-to-unsigned-long.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/convolver-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/convolver-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/create-native-offline-audio-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/data-clone-error.js
  var createDataCloneError = () => new DOMException("", "DataCloneError");

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/detach-array-buffer.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/decode-audio-data.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/decrement-cycle-counter.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/delay-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/delay-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/delete-active-input-connection-to-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/delete-unrendered-audio-worklet-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/guards/delay-node.js
  var isDelayNode = (audioNode) => {
    return "delayTime" in audioNode;
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/detect-cycles.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/disconnect-multiple-outputs.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/dynamics-compressor-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/dynamics-compressor-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/encoding-error.js
  var createEncodingError = () => new DOMException("", "EncodingError");

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/evaluate-source.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/event-target-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/expose-current-frame-and-current-time.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/fetch-source.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/gain-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/gain-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/get-active-audio-worklet-node-inputs.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/get-audio-node-renderer.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/get-audio-node-tail-time.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/get-audio-param-renderer.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/get-backup-offline-audio-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/invalid-state-error.js
  var createInvalidStateError = () => new DOMException("", "InvalidStateError");

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/get-native-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/get-or-create-backup-offline-audio-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/get-unrendered-audio-worklet-nodes.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/invalid-access-error.js
  var createInvalidAccessError = () => new DOMException("", "InvalidAccessError");

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/wrap-iir-filter-node-get-frequency-response-method.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/iir-filter-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/filter-buffer.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/iir-filter-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/increment-cycle-counter-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-any-audio-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-any-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-any-audio-param.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-any-offline-audio-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-native-audio-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-native-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-native-audio-param.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-native-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-native-offline-audio-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/is-secure-context.js
  var createIsSecureContext = (window3) => window3 !== null && window3.isSecureContext;

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/media-element-audio-source-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/media-stream-audio-destination-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/media-stream-audio-source-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/media-stream-track-audio-source-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/minimal-audio-context-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/minimal-base-audio-context-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-promise-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/minimal-offline-audio-context-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/monitor-connections.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/assign-native-audio-node-option.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/assign-native-audio-node-options.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-analyser-node-get-float-time-domain-data-method-support.js
  var testAnalyserNodeGetFloatTimeDomainDataMethodSupport = (nativeAnalyserNode) => {
    return typeof nativeAnalyserNode.getFloatTimeDomainData === "function";
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/wrap-analyser-node-get-float-time-domain-data-method.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-analyser-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-audio-buffer-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/assign-native-audio-node-audio-param-value.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/wrap-audio-scheduled-source-node-stop-method-negative-parameters.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-audio-buffer-source-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-audio-context-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-audio-destination-node.js
  var createNativeAudioDestinationNodeFactory = (createNativeGainNode2, overwriteAccessors2) => {
    return (nativeContext, channelCount, isNodeOfNativeOfflineAudioContext) => {
      ...
      overwriteAccessors2(gainNode, "channelCount", (get9) => () => get9.call(gainNode), (set) => (value) => {
      ...
      overwriteAccessors2(gainNode, "channelCountMode", (get9) => () => get9.call(gainNode), (set) => (value) => {
        set.call(gainNode, value);
        nativeAudioDestinationNode.channelCountMode = value;
      });
      overwriteAccessors2(gainNode, "channelInterpretation", (get9) => () => get9.call(gainNode), (set) => (value) => {
        set.call(gainNode, value);
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-audio-worklet-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-clonability-of-audio-worklet-node-options.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-audio-worklet-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/compute-buffer-size.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/clone-audio-worklet-node-options.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/create-audio-worklet-processor-promise.js
  var createAudioWorkletProcessorPromise = async (processorConstructor, audioWorkletNodeOptions) => {
    const clonedAudioWorkletNodeOptions = await cloneAudioWorkletNodeOptions(audioWorkletNodeOptions);
    return new processorConstructor(clonedAudioWorkletNodeOptions);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/create-audio-worklet-processor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-audio-worklet-node-faker-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-biquad-filter-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-channel-merger-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/wrap-channel-splitter-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-channel-splitter-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-constant-source-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/intercept-connections.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-constant-source-node-faker-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-convolver-node-factory.js
  var createNativeConvolverNodeFactory = (createNotSupportedError2, overwriteAccessors2) => {
    return (nativeContext, options) => {
      ...
      overwriteAccessors2(nativeConvolverNode, "channelCount", (get9) => () => get9.call(nativeConvolverNode), (set) => (value) => {
        if (value > 2) {
          throw createNotSupportedError2();
        }
      ...
      overwriteAccessors2(nativeConvolverNode, "channelCountMode", (get9) => () => get9.call(nativeConvolverNode), (set) => (value) => {
        if (value === "max") {
          throw createNotSupportedError2();
        }
        return set.call(nativeConvolverNode, value);
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-delay-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-dynamics-compressor-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-gain-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-iir-filter-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-iir-filter-node-faker-factory.js
  function divide(a, b) {
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-media-element-audio-source-node.js
  var createNativeMediaElementAudioSourceNode = (nativeAudioContext, options) => {
    return nativeAudioContext.createMediaElementSource(options.mediaElement);
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-media-stream-audio-destination-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-media-stream-audio-source-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-media-stream-track-audio-source-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-offline-audio-context-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-oscillator-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-panner-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-panner-node-faker-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-periodic-wave-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-script-processor-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-stereo-panner-node-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-stereo-panner-node-faker-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-wave-shaper-node-factory.js
  var createNativeWaveShaperNodeFactory = (createConnectedNativeAudioBufferSourceNode2, createInvalidStateError2, createNativeWaveShaperNodeFaker2, isDCCurve2, monitorConnections2, nativeAudioContextConstructor2, overwriteAccessors2) => {
    return (nativeContext, options) => {
      ...
      let isConnected = false;
      overwriteAccessors2(nativeWaveShaperNode, "curve", (get9) => () => get9.call(nativeWaveShaperNode), (set) => (value) => {
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/native-wave-shaper-node-faker-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/not-supported-error.js
  var createNotSupportedError = () => new DOMException("", "NotSupportedError");

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/offline-audio-context-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/oscillator-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/oscillator-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/panner-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/panner-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/periodic-wave-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/render-automation.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/render-inputs-of-audio-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/render-inputs-of-audio-param.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/render-native-offline-audio-context.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/set-active-audio-worklet-node-inputs.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/set-audio-node-tail-time.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/start-rendering.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/stereo-panner-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/stereo-panner-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/test-audio-buffer-constructor-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/test-audio-worklet-processor-post-message-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/test-offline-audio-context-current-time-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/unknown-error.js
  var createUnknownError = () => new DOMException("", "UnknownError");

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/wave-shaper-node-constructor.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/wave-shaper-node-renderer-factory.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/window.js
  var createWindow = () => typeof window === "undefined" ? null : window;

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/wrap-audio-buffer-copy-channel-methods.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/wrap-audio-buffer-copy-channel-methods-out-of-bounds.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/wrap-audio-buffer-source-node-stop-method-nullified-buffer.js
  var createWrapAudioBufferSourceNodeStopMethodNullifiedBuffer = (overwriteAccessors2) => {
    return (nativeAudioBufferSourceNode, nativeContext) => {
      ...
      overwriteAccessors2(nativeAudioBufferSourceNode, "buffer", (get9) => () => {
        const value = get9.call(nativeAudioBufferSourceNode);
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/factories/wrap-channel-merger-node.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/get-first-sample.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/is-dc-curve.js
  var isDCCurve = (curve) => {
    if (curve === null) {
      return false;
    }
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/overwrite-accessors.js
  var overwriteAccessors = (object, property, createGetter, createSetter) => {
    let prototype = object;
    while (!prototype.hasOwnProperty(property)) {
      prototype = Object.getPrototypeOf(prototype);
    }
    const { get: get9, set } = Object.getOwnPropertyDescriptor(prototype, property);
    Object.defineProperty(object, property, { get: createGetter(get9), set: createSetter(set) });
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/sanitize-audio-worklet-node-options.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/sanitize-channel-splitter-options.js
  var sanitizeChannelSplitterOptions = (options) => {
    return { ...options, channelCount: options.numberOfOutputs };
  };

  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/sanitize-periodic-wave-options.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/set-value-at-time-until-possible.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-buffer-source-node-start-method-consecutive-calls-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-buffer-source-node-start-method-offset-clamping-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-buffer-source-node-stop-method-nullified-buffer-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-scheduled-source-node-start-method-negative-parameters-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-scheduled-source-node-stop-method-consecutive-calls-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-scheduled-source-node-stop-method-negative-parameters-support.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/test-audio-worklet-node-options-clonability.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/wrap-audio-scheduled-source-node-stop-method-consecutive-calls.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/helpers/wrap-event-listener.js
  ...
  // ../../node_modules/.pnpm/standardized-audio-context@25.3.77/node_modules/standardized-audio-context/build/es2019/module.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/TypeCheck.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/Debug.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/AudioContext.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/clock/Ticker.js
  var Ticker = class {
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/AdvancedTypeCheck.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/Defaults.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/Tone.js
  var Tone = class {
    constructor() {
      this.debug = false;
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/Math.js
  var EPSILON = 1e-6;
  function GT(a, b) {
    return a > b + EPSILON;
  }
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/Timeline.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/ContextInitialization.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/Emitter.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/BaseContext.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/Context.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/DummyContext.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/Interface.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/ToneAudioBuffer.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/OfflineContext.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/Global.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/type/Conversions.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/type/TimeBase.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/type/Time.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/type/Frequency.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/type/TransportTime.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/ToneWithContext.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/StateTimeline.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/Param.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/ToneAudioNode.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/Gain.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/OneShotSource.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/ToneConstantSource.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/Signal.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/clock/TickParam.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/clock/TickSignal.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/clock/TickSource.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/clock/Clock.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/Delay.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/ToneAudioBuffers.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/type/Midi.js
  var MidiClass = class _MidiClass extends FrequencyClass {
     ...
     */
    transpose(interval2) {
      return new _MidiClass(this.context, this.toMidi() + interval2);
    }
  };

  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/type/Ticks.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/Draw.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/IntervalTimeline.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/channel/Volume.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/Destination.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/TimelineValue.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/SignalOperator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/WaveShaper.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/Pow.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/clock/TransportEvent.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/clock/TransportRepeatEvent.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/clock/Transport.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/Source.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/buffer/ToneBufferSource.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/Noise.js
  var BUFFER_LENGTH = 44100 * 5;

  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/OscillatorInterface.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/ToneOscillatorNode.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/Oscillator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/AudioToGain.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/Multiply.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/AMOscillator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/FMOscillator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/PulseOscillator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/FatOscillator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/PWMOscillator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/oscillator/OmniOscillator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/Add.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/Scale.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/util/Decorator.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/source/buffer/Player.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/signal/GainToAudio.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/envelope/Envelope.js
  ...
  var EnvelopeCurves = (() => {
    ...
    const steps3 = 5;
    for (i = 0; i < curveLen; i++) {
      stairsCurve[i] = Math.ceil(i / (curveLen - 1) * steps3) / steps3;
    }
    const sineCurve = [];
    for (i = 0; i < curveLen; i++) {
      k = i / (curveLen - 1);
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/instrument/Instrument.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/instrument/Monophonic.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/envelope/AmplitudeEnvelope.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/instrument/Synth.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/filter/BiquadFilter.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/filter/Filter.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/envelope/FrequencyEnvelope.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/instrument/MonoSynth.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/instrument/MetalSynth.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/instrument/MembraneSynth.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/worklet/WorkletGlobalScope.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/worklet/ToneAudioWorkletProcessor.worklet.js
...
`
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/worklet/SingleIOProcessor.worklet.js
  var singleIOProcess = (
    /* javascript */
    `
	/**
...
`
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/worklet/DelayLine.worklet.js
  var delayLine = (
    /* javascript */
    `
	/**
...
`
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/filter/FeedbackCombFilter.worklet.js
...
`
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/instrument/PolySynth.js
  var PolySynth = class _PolySynth extends Instrument {
    constructor() {
      ...
      const index4 = this._voices.indexOf(this._dummyVoice);
      this._voices.splice(index4, 1);
    ...
    _collectGarbage() {
      ...
      if (this._availableVoices.length && this._voices.length > Math.ceil(this._averageActiveVoices + 1)) {
        ...
        const index4 = this._voices.indexOf(firstAvail);
        this._voices.splice(index4, 1);
        if (!this.context.isOffline) {
          firstAvail.dispose();
        }
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/instrument/Sampler.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/channel/CrossFade.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/effect/Effect.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/channel/Panner.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/effect/BitCrusher.worklet.js
...
`
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/effect/Distortion.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/effect/FeedbackEffect.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/effect/FeedbackDelay.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/effect/Freeverb.js
  var combFilterTunings = [1557 / 44100, 1617 / 44100, 1491 / 44100, 1422 / 44100, 1277 / 44100, 1356 / 44100, 1188 / 44100, 1116 / 44100];

  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/effect/JCReverb.js
  var combFilterDelayTimes = [1687 / 25e3, 1601 / 25e3, 2053 / 25e3, 2251 / 25e3];

  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/channel/Solo.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/channel/PanVol.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/channel/Channel.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/core/context/Listener.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/dynamics/Compressor.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/component/dynamics/Limiter.js
  ...
  // ../../node_modules/.pnpm/tone@14.9.17/node_modules/tone/build/esm/index.js
  function now() {
  ...
  // ../dsp-tone/src/adapter.ts
  var ToneTransport = class {
    get position() {
    ...
    start(at) {
      if (at) {
        Transport.start(`+0.1`, `${at.bars}:${at.beats}:${at.sixteenths}`);
      } else {
        Transport.start();
      }
    }
    ...
    getTelemetry() {
      return {
        scheduledEvents: this._scheduled,
        lateEvents: this._late,
        maxLatenessMs: this._maxLateness
      };
    }
    wrapCallback(cb) {
      this._scheduled++;
      return (time) => {
        const now2 = now();
        const latenessMs = (now2 - time) * 1e3;
        if (latenessMs > 10) {
          this._late++;
          if (latenessMs > this._maxLateness) {
            this._maxLateness = latenessMs;
          }
        }
        cb(time);
      };
    ...
    schedule(event) {
      const timeStr = `${event.time.bars}:${event.time.beats}:${event.time.sixteenths}`;
      return Transport.schedule(this.wrapCallback(event.callback), timeStr);
    }
    scheduleAtBoundary(boundary, callback) {
  ...
  var ToneTearScoreRuntime = class extends AbstractTearScoreRuntime {
    ...
    onMuteStateChanged(isMuted) {
      ...
      if (isMuted) {
        this._masterBus.gain.rampTo(0, 0.1);
      } else {
        this._masterBus.gain.rampTo(1, 0.1);
      }
    }
  };

  // ../dsp-tone/src/instruments.ts
  var ToneVoice = class {
    constructor(synth) {
      this.synth = synth;
    }
    synth;
    triggerAttack(note2, time, velocity) {
      this.synth.triggerAttack(note2, time, velocity);
    }
    triggerRelease(time) {
      this.synth.triggerRelease(time);
    }
    triggerAttackRelease(note2, duration, time, velocity) {
      this.synth.triggerAttackRelease(note2, duration, time, velocity);
    }
    dispose() {
      this.synth.dispose();
    }
  ...
  var Director = class {
    ...
    updateContext(ctx) {
      ...
      this.currentDimensions = this.deriveDimensions(ctx);
      this.updateTier(this.currentDimensions);
    }
    getDimensions() {
    ...
    deriveDimensions(ctx) {
      const liveEnemies = ctx.liveEnemies ?? 0;
      const queuedEnemies = ctx.queuedEnemies ?? 0;
      const projectileCount = ctx.projectileCount ?? 0;
      const healthRatio = ctx.player?.healthRatio ?? 1;
      const comboRank = ctx.player?.comboRank ?? "NONE";
      const normalize = (val, min, max) => Math.max(0, Math.min(1, (val - min) / (max - min)));
      const enemyPressure = normalize(liveEnemies, 0, 8) * 0.65 + normalize(queuedEnemies, 0, 8) * 0.35;
      const projectilePressure = normalize(projectileCount, 0, 12);
      let comboMomentum = 0;
      switch (comboRank) {
        case "NICE":
          comboMomentum = 0.2;
      ...
      const bossDanger = ctx.boss?.active ? 1 - (ctx.boss.healthRatio ?? 1) : 0;
      const danger = (1 - healthRatio) * 0.55 + enemyPressure * 0.2 + projectilePressure * 0.15 + bossDanger * 0.1;
      const hordeWeight = ctx.horde ? 1 : 0;
      const miniBossWeight = ctx.miniBoss ? 1 : 0;
      const bossWeight = ctx.boss?.active ? 1 : 0;
      const intensity = enemyPressure * 0.3 + projectilePressure * 0.1 + comboMomentum * 0.25 + hordeWeight * 0.15 + miniBossWeight * 0.1 + bossWeight * 0.3;
      const tension = ctx.boss?.active ? 0.8 : enemyPressure * 0.5 + projectilePressure * 0.5;
      return {
        intensity: Math.min(1, intensity),
        tension: Math.min(1, tension),
        momentum: Math.min(1, comboMomentum),
        danger: Math.min(1, danger)
      };
    }
    updateTier(dim) {
      const score = dim.intensity;
      let newTier = this.currentTier;
      if (this.currentTier === 0) {
        if (score >= 0.12) newTier = 1;
      } else if (this.currentTier === 1) {
        if (score >= 0.32) newTier = 2;
        else if (score < 0.06) newTier = 0;
      } else if (this.currentTier === 2) {
        if (score >= 0.58) newTier = 3;
        else if (score < 0.22) newTier = 1;
      } else if (this.currentTier === 3) {
        if (score >= 0.82) newTier = 4;
        else if (score < 0.45) newTier = 2;
      } else if (this.currentTier === 4) {
        if (score < 0.68) newTier = 3;
      }
      if (this.lastContext?.boss?.active && this.lastContext?.boss?.healthRatio && this.lastContext?.boss?.healthRatio < 0.25) {
        newTier = 4;
      }
      const breathingScreens = ["menu", "draft", "tierup", "lore", "win"];
      if (this.lastContext && breathingScreens.includes(this.lastContext.screen)) {
  ...
  function pcsetFromMidi(midi2) {
    return midi2.map(chroma2).sort((a, b) => a - b).filter((n, i, a) => i === 0 || n !== a[i - 1]);
  }
  ...
  function pcsetDegrees(notes2, tonic) {
    const steps3 = pcsetSteps(notes2, tonic);
    return (degree) => {
  ...
  var chroma3 = (note2) => get5(note2).chroma;
  ...
  var topNoteDiff = (voicings, lastVoicing) => {
    ...
    const topNoteMidi = (voicing) => index_default3.midi(voicing[voicing.length - 1]) || 0;
  ...
  var defaultDictionary2 = index_default6.all;
  var defaultVoiceLeading = index_default5.topNoteDiff;
  ...
  // ../theory/src/scales.ts
  function getMidiFromDegree(context2, degree) {
    const scale2 = dist_exports2.get(`${context2.tonic} ${context2.type}`);
    if (scale2.empty) return null;
    const len = scale2.notes.length;
    const zeroDegree = degree - 1;
    const octaveOffset = Math.floor(zeroDegree / len);
    const noteIndex = (zeroDegree % len + len) % len;
    const noteName = scale2.notes[noteIndex];
    const targetOctave = context2.baseOctave + octaveOffset;
    return dist_exports.toMidi(`${noteName}${targetOctave}`);
  }

  // ../composer/src/generator.ts
  var PhraseGenerator = class {
    prng;
    dspRack;
    constructor(seed, dspRack) {
      this.prng = new PRNG(seed);
      this.dspRack = dspRack;
    }
    /**
     * Generates a deterministic sequence of notes for a given phrase window based on authored tracks.
     */
    generatePhrase(startBar, startBeat, config) {
      const events = [];
      for (const [trackId, trackDef] of Object.entries(config.phrase.tracks)) {
        const voice = this.dspRack.getVoice(trackDef.instrument);
        if (!voice) continue;
        for (const pattern of trackDef.patterns) {
          const beatsOffset = Math.floor(pattern.time / 4);
          const sixteenthsOffset = pattern.time % 4;
          let targetBeat = startBeat + beatsOffset;
          let targetBar = startBar;
          if (targetBeat >= 4) {
            targetBar += Math.floor(targetBeat / 4);
            targetBeat = targetBeat % 4;
          }
          let pitchToPlay = "C4";
          if (pattern.note) {
            pitchToPlay = pattern.note;
          } else if (pattern.degree) {
            const effectiveScale = {
              ...config.scale,
              baseOctave: config.scale.baseOctave + (pattern.octaveOffset || 0)
            };
            const midi2 = getMidiFromDegree(effectiveScale, pattern.degree);
            if (midi2) {
              pitchToPlay = midi2;
            }
          } else {
  ...
  var TearScoreComposer = class {
    runtime;
    director;
    dspRack;
    document = null;
    prng;
    // The bar we have currently generated events up to.
    // Starts at -1 meaning we haven't scheduled anything yet.
    scheduledUpToBar = -1;
    // How many bars ahead of the current transport bar we should schedule.
    lookaheadBars = 1;
    constructor(runtime, director, dspRack) {
      this.runtime = runtime;
      this.director = director;
      this.dspRack = dspRack;
      this.prng = new PRNG("composer-seed");
    }
    load(doc) {
      this.document = doc;
      this.scheduledUpToBar = -1;
    }
    /**
     * Called continuously by the host (e.g. at 10Hz or 60Hz).
     * Checks the transport's current bar and schedules lookahead phrases if needed.
     */
    tick(currentBar) {
      if (!this.document) return;
      if (this.scheduledUpToBar === -1) {
        this.scheduledUpToBar = currentBar - 1;
      }
      const targetBar = currentBar + this.lookaheadBars;
      while (this.scheduledUpToBar < targetBar) {
        const barToSchedule = this.scheduledUpToBar + 1;
        this.scheduleBar(barToSchedule);
        this.scheduledUpToBar = barToSchedule;
      }
    }
    scheduleBar(bar) {
      if (!this.document) return;
      const currentTier = this.director.getTier();
      const tierConfig = this.document.arrangement.tiers[currentTier];
      if (!tierConfig || tierConfig.phrases.length === 0) {
        return;
      }
      const measureSeed = `bar-${bar}-tier-${currentTier}`;
      const localPrng = new PRNG(measureSeed);
      const phraseIndex = localPrng.nextInt(0, tierConfig.phrases.length - 1);
      const phraseId = tierConfig.phrases[phraseIndex];
      const phraseDef = this.document.phrases[phraseId];
      if (!phraseDef) return;
      const scaleCtx = {
        tonic: this.document.global.scale.tonic,
        type: this.document.global.scale.type,
        baseOctave: this.document.global.scale.baseOctave
      };
      const config = {
        scale: scaleCtx,
        phrase: phraseDef
      };
      const phraseSeed = `phrase-${bar}-${phraseId}`;
      const generator = new PhraseGenerator(phraseSeed, this.dspRack);
      const events = generator.generatePhrase(bar, 0, config);
      for (const ev of events) {
        this.runtime.transport.schedule(ev);
      }
    }
  };

  // ../testing/dist/index.mjs
  var groundsBlueprint = {
    version: "1.0.0",
    meta: {
      name: "Grounds Dynamic",
      description: "A dynamic theme for the grounds biome",
      author: "Shaku"
    },
    global: {
      tempo: 120,
        ...
        tracks: {
          ...
          "pluck": {
            ...
            patterns: [
              ...
              { time: 10, duration: 4, degree: 3, octaveOffset: 2 }
            ]
          }
        }
      },
        ...
        tracks: {
          ...
          "pluck": {
            ...
            patterns: [
              ...
              { time: 6, duration: 2, degree: 3, octaveOffset: 2 },
              { time: 10, duration: 2, degree: 5, octaveOffset: 2 },
              { time: 14, duration: 2, degree: 7, octaveOffset: 2 }
              // C
            ]
          }
        }
        ...
        tracks: {
          ...
          "hat": {
            ...
            patterns: [
              ...
              { time: 2, duration: 2 },
              { time: 4, duration: 2, velocity: 0.5 },
              { time: 6, duration: 2 },
              { time: 8, duration: 2, velocity: 0.5 },
              { time: 10, duration: 2 },
              { time: 12, duration: 2, velocity: 0.5 },
              { time: 14, duration: 2 }
            ]
          },
          "sub": {
        ...
        tracks: {
          ...
          "pluck": {
            ...
            patterns: [
              ...
              { time: 6, duration: 2, degree: 3, octaveOffset: 2 },
              { time: 10, duration: 2, degree: 5, octaveOffset: 2 },
              { time: 12, duration: 2, degree: 7, octaveOffset: 2 },
              { time: 14, duration: 2, degree: 1, octaveOffset: 3 }
            ]
          }
        }
      }
    ...
    arrangement: {
      tiers: {
        0: { phrases: ["ambient-1"] },
        1: { phrases: ["ambient-1", "ambient-2"] },
        2: { phrases: ["beat-1"] },
        3: { phrases: ["beat-1", "beat-2"] },
        4: { phrases: ["climax"] }
      }
    }
  };
  ...
  var undercroftBlueprint = {
    version: "1.0.0",
    meta: {
      name: "Undercroft Theme",
      description: "Deep and dark theme for the Undercroft biome",
      author: "Shaku"
    },
    global: {
      tempo: 110,
  ...
  var crimsonFieldsBlueprint = {
    version: "1.0.0",
    meta: {
      name: "Crimson Fields Theme",
      description: "Aggressive and tense theme",
      author: "Shaku"
    },
    global: {
      tempo: 140,
        ...
        tracks: {
          ...
          "lead": {
            ...
            patterns: [
              ...
              { time: 2, duration: 2, degree: 2, octaveOffset: 1 },
              { time: 6, duration: 2, degree: 3, octaveOffset: 1 }
            ]
          }
        }
      }
  ...
  var voidspireBlueprint = {
    version: "1.0.0",
    meta: {
      name: "Voidspire Theme",
      description: "Atonal and chaotic theme",
      author: "Shaku"
    },
    global: {
      tempo: 160,
      ...
      "ambient": {
        ...
        tracks: {
          "texture": {
            ...
            patterns: [
              { time: 0, duration: 16, degree: 1, octaveOffset: 0 },
              { time: 4, duration: 16, degree: 5, octaveOffset: 0 },
              { time: 12, duration: 16, degree: 8, octaveOffset: 1 }
            ]
          }
        }
      }
  ...
  var tearBlueprint = {
    ...
    meta: {
      name: "Tear Theme",
      description: "The core Tear entity theme",
      author: "Shaku"
    },
    global: {
      tempo: 100,
        ...
        tracks: {
          ...
          "pluck": {
            ...
            patterns: [
              ...
              { time: 8, duration: 4, degree: 5, octaveOffset: 1 }
            ]
          }
        }
      }
  ...
  var endingBlueprint = {
    ...
    meta: {
      name: "Ending Theme",
      description: "Resolution and epilogue",
      author: "Shaku"
    },
    global: {
      tempo: 80,
  ...
  var TearScoreAPI = class {
    ...
    updateContext(ctx) {
      ...
      if (ctx.screen === "menu") {
        targetBlueprint = menuBlueprint;
        targetBlueprintId = "menu";
      } else if (ctx.screen === "ending") {
        targetBlueprint = endingBlueprint;
        targetBlueprintId = "ending";
      } else if (ctx.screen === "playing") {
        switch (ctx.biome) {
          case "The Grounds":
            targetBlueprint = groundsBlueprint;
            targetBlueprintId = "grounds";
            break;
          case "The Crimson Fields":
            targetBlueprint = crimsonFieldsBlueprint;
            targetBlueprintId = "crimson-fields";
            break;
          case "The Undercroft":
            targetBlueprint = undercroftBlueprint;
            targetBlueprintId = "undercroft";
            break;
          case "The Voidspire":
            targetBlueprint = voidspireBlueprint;
            targetBlueprintId = "voidspire";
            break;
          case "The Tear":
            targetBlueprint = tearBlueprint;
            targetBlueprintId = "tear";
            break;
          default:
            targetBlueprint = groundsBlueprint;
            targetBlueprintId = "grounds";
      ...
      if (this.currentBlueprintId !== targetBlueprintId) {
